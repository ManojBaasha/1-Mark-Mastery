...
class Maths_Deleted_Portions extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: Text("Maths Deleted Portions"),
        ...
        body: ListView(
          children: <Widget>[
            ListTile(
              ...
              title: Text('Chapter-1,Relations And Functions',
                  style: new TextStyle(fontSize: 30.0)),
              subtitle: Text("Ex:1.3[All Questions]\n,"
                  "Ex1.4[Already Deleted]\n"
                  "Misc Ex:Q:1,2,3,6,7,9,11,12,13,14,18,19"),
            ),
            ListTile(
              leading: Icon(Icons.question_answer),
              title: Text("Chapter-2,Inverse Trigonometric Functions",
                  style: new TextStyle(fontSize: 30.0)),
              subtitle: Text(""),
            ),
            ListTile(
