...
import 'package:class_app/constants.dart';
...
class _BodyState extends State<Body> {
  ...
  List<Map<String, String>> splashData = [
    {
      "text": "Congragulations on downloading the app \nYou're halfway there!",
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    DefaultButton(
                      text: "Continue",
                      press: () {
                        Navigator.pushNamed(context, FrontPage.routeName);
                      },
                    ),
                    Spacer(),
                  ],
  ...
  AnimatedContainer buildDot({int index}) {
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        color: currentPage == index ? Color(0xFF21BFBD) : Color(0xFFD8D8D8),
